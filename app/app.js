...
/*
 *    lista das rotas disponiveis no monento

 *  endereco base:   https://casa-fscp.onrender.com
    auth/signin -> login
 *  auth/signup -> cadastrar
 *  /profile -> ver dados deste mesmo perfil
*/
...
//rota index
app.get('/', (req, res) => {
    res.send(`📌 Documentação da API – Casa Cheia
